...
// This function creates a new blockchain with an initial genesis block. And it assigns event listeners
// to the buttons that add pending transactions and initiate new block mining.
